                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><button type="button" data-toggle="popover-custom-content" rel="popover-focus" popover-id="KCA<?php echo $reg['idCotizacionDet'] ?>" class="mr-2 mb-2 btn btn-warning"><?php echo number_format($reg['cantidad'], 2, '.', ',') ?></button></td>
