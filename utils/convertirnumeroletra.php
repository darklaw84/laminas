...
class CifrasEnLetras {
  ...
  static function convertirMes($mes)
  {
    $mesS="";
      switch($mes)
      {
  ...
  */
  public static function convertirPesosEnLetras($euros, $numeroDecimales=2) {
    return self::convertirNumeroEnLetras($euros, $numeroDecimales,
      "peso", "pesos", false, "centavo", "centavos", false);
  }
